...
# We explicitly call 'up' only on the target slot. The live slot is untouched.
# VIRTUAL_HOST_SET is NOT used in the shell, preserving the live slot's VIRTUAL_HOST.
